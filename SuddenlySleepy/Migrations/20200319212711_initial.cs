    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SSEventId = table.Column<Guid>(nullable: false),
                    MeetingDate = table.Column<DateTime>(nullable: false),
                    Location = table.Column<string>(nullable: true),
                    SSEventName = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SSEvents", x => x.SSEventId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SSUsers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SSUserSSEvent", x => new { x.SSUserId, x.SSEventId });
                    table.ForeignKey(
                        name: "FK_SSUserSSEvent_SSEvents_SSEventId",
                        column: x => x.SSEventId,
